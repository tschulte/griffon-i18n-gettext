class SubModuleAddonGriffonAddon {
    // lifecycle methods
    ...
    //]
    def mvcGroups = [
        // MVC Group for "SubModuleMvc"
        'SubModuleMvc' : [
            model : 'submodule.SubModuleMvcModel',
            view : 'submodule.SubModuleMvcView',
            controller : 'submodule.SubModuleMvcController'
        ]
